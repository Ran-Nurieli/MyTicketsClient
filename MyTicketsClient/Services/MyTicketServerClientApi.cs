...
namespace MyTicketsClient.Services
{
    public class MyTicketServerClientApi
    {
        ...
        public static string BaseAddress = DeviceInfo.Platform == DevicePlatform.Android ? "https://pfzjggll-5198.euw.devtunnels.ms/api/TicketServerApi/" : "http://localhost:5198/api/TicketServerApi/";
